...
public class main {
    public static void main(String[] args) {
        ...
        /*String s = "";

        System.out.println(exo12.f(exo11.f(s)));*/

        /*exo14.f(s, exo7.f(exo6.f(s), s));*/

        String s = "BILKO PFFGM LTWOE WJCFD SHKWO NKSEO VUSGR LWHGW FNVKW GGGFN RFHYJ VSGRF RIEKD CCGBH RYSXV KDIJA HCFFG YEFSG ZWG";

        s = exo2.f(s);

        /*System.out.println(exo15.f(s, "attaque", 24));*/

        System.out.println(exo16.f(s, "attaque"));
    }
}
